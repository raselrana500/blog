        ...
        <div class="block">  
			...
			?>
				<tr class="odd gradeX">
					...
					<td><img src="<?php echo $result['image']; ?>" height="40px" width="60"/></td>
...
<td>
	...
	<?php if (session::get('userID') == $result['userid'] || session::get('userRole')=='0') { ?>
		...
		<a onclick="return confirm('Are you sure to Delete ! ');"; href="deletepost.php?deletpostid=<?php echo $result['id']; ?>">Delete</a>
	<?php } ?>
